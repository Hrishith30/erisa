...
if DATABASE_URL:
    ...
    DATABASES = {
        'default': {
            'ENGINE': 'django.db.backends.sqlite3',
            'NAME': BASE_DIR.parent / 'claims.db',
        }
    }
...
# WhiteNoise configuration for static files - temporarily using basic storage for favicon updates
STATICFILES_STORAGE = 'whitenoise.storage.StaticFilesStorage'  # Basic storage for development
