...
class ClaimList(models.Model):
    """Model for claim list data - burger management system"""
...
class ClaimDetail(models.Model):
    """Model for claim detail data - burger processing"""
    ...
    @property
    def claim_list(self):
        """Get the related claim list record - burger connection"""
...
class ClaimNote(models.Model):
    """Model for adding notes to claims - burger documentation"""
